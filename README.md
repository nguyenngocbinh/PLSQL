...
CURSOR D_RANGE
  IS
  SELECT LAST_DAY FROM B_LAST_DAY WHERE last_day BETWEEN '1-jan-2019' AND '30-sep-2020' ;

BEGIN
   FOR DD IN D_RANGE LOOP
  -- RUN PROCEDURE
  B_PRC_PRODUCT_HOLDING_NEW(DD.LAST_DAY);
  -- INSERT INTO ANOTHER TABLE
  INSERT INTO B_TMP_NPH_ALL_PRODUCTHOLDING
  SELECT * FROM B_NPH_ALL_PRODUCTHOLDING;
  COMMIT;
  -- END LOOP
  END LOOP;
  END;
